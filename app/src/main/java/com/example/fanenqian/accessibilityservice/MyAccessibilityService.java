package com.example.fanenqian.accessibilityservice;
...
/**
 * Created by fanenqian on 2017/12/15.
 */
...
public class MyAccessibilityService extends AccessibilityService {
    ...
    private void getPacket() {
        ...
        System.out.println(rootNode.getText().toString() + "----xx");
        AccessibilityNodeInfo node = recycle(rootNode);
        System.out.println(node.getText() + "----2");
    ...
    public AccessibilityNodeInfo recycle(AccessibilityNodeInfo node) {
        ...
        //        System.out.println(node.getText() + "----111");
        return node;
    }
